...
Below is a pseudo-code representation of of the Adam optimizer (Algorithm \cref{fig:adam_alg}). Refer to Table \cref{fig:adam_table} for explanation of the components and notation in the description of the optimizer.
...
We have two probabilities, sentiment being positive and sentiment negative. If \(f(x)\) is our algorithms probability of the sentiment being positive, then the algorithm's prediction for the negative probability is \(1-f(x)\).
